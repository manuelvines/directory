               ...
               <form  method="POST" action="{{ route('experience.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-12 form-group">
                            ...
                            <input  class="form-control" type="text" value="{{ $experience->title }}" name="title" id="title">
                        </div>
                    </div>
                     ...
                     <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-6 form-group">
                            ...
                            <input  class="form-control" type="time" name="initial_schedule" id="initial_schedule" value="{{ $experience->initial_schedule }}">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 form-group">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 form-group">
                         ...
                         <textarea name="restrictions" id="restrictions" cols="30" rows="10">{!! $experience->restrictions  !!}</textarea>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 form-group">
                         ...
                         <textarea name="tips" id="tips" cols="30" rows="10">{!! $experience->tips  !!}</textarea>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 form-group">
                         ...
                         <textarea name="extra_expenses" id="extra_expenses" cols="30" rows="10">{!! $experience->extra_expenses  !!}</textarea>
